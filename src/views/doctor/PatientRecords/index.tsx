        ...
        return (
            <Card>
                <div className="p-4">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="ml-3">
                                ...
                                <div className="text-gray-500">
                                    {selectedPatient.age} years old • {selectedPatient.gender} • {selectedPatient.bloodGroup}
                                </div>
                        ...
                        <Card className="md:col-span-2">
                            <div className="p-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <div className="text-gray-500 mb-1">Medical Conditions</div>
                                        <div className="flex flex-wrap gap-1">
                                    ...
                                    <div>
                                        <div className="text-gray-500 mb-1">Medications</div>
                    ...
                    <div className="mt-4">
                        <Tabs defaultValue="overview" value={activeTab} onChange={(val) => setActiveTab(val)}>
                            <Tabs.TabList>
                                <Tabs.TabNav value="overview">Overview</Tabs.TabNav>
                                <Tabs.TabNav value="consultations">Consultation History</Tabs.TabNav>
                                <Tabs.TabNav value="documents">Medical Documents</Tabs.TabNav>
                                <Tabs.TabNav value="prescriptions">Prescriptions</Tabs.TabNav>
                            </Tabs.TabList>
                            <Tabs.TabContent value="overview">
                                <Card className="mt-4">
                                    <div className="p-4">
                                        <h5 className="font-semibold mb-3">Patient Summary</h5>
                                        <div className="text-gray-600">
                                            <p>{selectedPatient.name} is a {selectedPatient.age}-year-old {selectedPatient.gender.toLowerCase()} 
                                               with a history of {selectedPatient.conditions.join(', ')}.
                                            </p>
                                            <p className="mt-2">
                                               The patient is currently on {selectedPatient.medications.join(', ')}.
                                            </p>
                                            {selectedPatient.allergies.length > 0 && (
                                                <p className="mt-2">
                                                    Known allergies: {selectedPatient.allergies.join(', ')}.
                                                </p>
                                            )}
                                            <p className="mt-2">
                                                Last visit was on {selectedPatient.lastVisit}.
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                    <Card>
                                        <div className="p-4">
                                            <h5 className="font-semibold mb-3">Recent Consultations</h5>
                                            {getPatientConsultations(selectedPatient.id).slice(0, 3).map((consultation, index) => (
                                                <div key={index} className="border-b pb-3 mb-3 last:border-0 last:mb-0 last:pb-0">
                                    ...
                                    <Card>
                                        <div className="p-4">
                                            <h5 className="font-semibold mb-3">Recent Documents</h5>
                                            {getPatientDocuments(selectedPatient.id).slice(0, 3).map((document, index) => (
                                                <div key={index} className="border-b pb-3 mb-3 last:border-0 last:mb-0 last:pb-0">
                                                    <div className="flex justify-between">
                                                    ...
                                                    <div className="flex justify-between mt-1">
                                                        ...
                                                        <a href={document.fileUrl} className="text-blue-600 hover:text-blue-800">
                                                            View
                                                        </a>
                                                    </div>
                                                </div>
                                ...
                                <Card className="mt-4">
                                    <div className="p-4">
                                        <div className="flex justify-between items-center mb-4">
                                            <h5 className="font-semibold">Consultation History</h5>
                                            <Button size="sm">
                                        ...
                                        <table className="min-w-full">
                                            ...
                                            <tbody>
                                                {getPatientConsultations(selectedPatient.id).map((consultation, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td className="px-4 py-2">{consultation.reason}</td>
                                                        <td className="px-4 py-2">{consultation.diagnosis}</td>
                                                        <td className="px-4 py-2">{consultation.notes}</td>
                                                        <td className="px-4 py-2">
                                                            <Button size="xs">
                                                                View Details
                                                            </Button>
                            ...
                            <Tabs.TabContent value="documents">
                                <Card className="mt-4">
                                    <div className="p-4">
                                        <div className="flex justify-between items-center mb-4">
                                            <h5 className="font-semibold">Medical Documents</h5>
                                            <Button size="sm">
                                                Upload New Document
                                            </Button>
                                        </div>
                                        ...
                                        <table className="min-w-full">
                                            ...
                                            <tbody>
                                                {getPatientDocuments(selectedPatient.id).map((document, index) => (
                                                    <tr key={index}>
                                ...
                                <Card className="mt-4">
                                    <div className="p-4">
                                        ...
                                        <div className="text-gray-600 py-16 text-center">
                                            <p>Prescriptions for this patient will appear here.</p>
                                            <p>Use the 'Add New Prescription' button to create a prescription.</p>
                                        </div>
                                    </div>
                                </Card>
                            </Tabs.TabContent>
    ...
    return (
        <Container>
            <div className="mb-4">
                ...
                <p className="text-gray-500">View and manage all your patient records</p>
            </div>
                                        ...
                                        <td className="px-4 py-2">
                                            <div className="flex space-x-2 justify-end">
                                                ...
                                                <Button 
                                                    ...
                                                    onClick={() => {
                                                        // Navigate to video consultation page with the patient details
                                                        window.location.href = `/doctor/video-consultation?patientId=${patient.id}`
                                                    }}
                                                >
                                                    Start Consultation
                                                </Button>
