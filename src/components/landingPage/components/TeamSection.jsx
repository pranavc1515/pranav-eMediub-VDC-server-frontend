...
const TeamSection = () => {
    return (
        <section className="bg-[#E6F6FE] xl:h-[667px] py-12 text-center">
            {/* Title */}
            <h2 className="text-[35px] xl:text-[42px] font-semibold text-[#011632]">
                Meet Our Teams
            </h2>
            <img src={Vector2} alt="Divider" className="w-[334px] mx-auto mb-4" />

            {/* Subtitle */}
            <p className="text-[#3C4959] text-[18px] font-[400] mx-auto pl-[20px] pr-[20px] xl:w-[800px]">
            ...
            <div className="flex justify-center mt-8 w-full mx-auto">
                <img
                    ...
                    className="rounded-[10px] shadow-lg w-full pl-[20px] pr-[20px] xl:max-w-4xl"
                />
            </div>
        </section>
    );
